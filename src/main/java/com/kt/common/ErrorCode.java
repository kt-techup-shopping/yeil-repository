...
public enum ErrorCode {
	...
	FAILED_LOGIN(HttpStatus.BAD_REQUEST, "아이디나 비밀번호가 일치하지 않습니다."),
	...
	NOT_ENOUGH_STOCK(HttpStatus.BAD_REQUEST, "상품 재고가 부족합니다."),
	INVALID_PARAMETER(HttpStatus.BAD_REQUEST, "필수값 누락입니다."),
	FAIL_ACQUIRED_LOCK(HttpStatus.BAD_REQUEST, "락을 획득하지 못했습니다."),
